...
<div class="page-header d-print-none">
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        <h2 class="page-title">
          Edit Berita: {{ Str::limit($post->title, 40) }}
        </h2>
      </div>
            ...
            <div class="row row-cards">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="editor" name="body" class="form-control">{{ old('body', $post->body) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-light border-0" style="border-radius: 8px;">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-dark"><i class="ti ti-photo me-1 text-primary"></i> Ganti Foto Utama</label>
                                @if($post->image)
                                    <img id="img-preview" src="{{ asset('storage/' . $post->image) }}" alt="Preview" class="img-fluid rounded border mb-2" style="max-height: 200px; width: 100%; object-fit: cover;">
                                @else
                                ...
                                <small class="form-hint mt-1">Biarkan kosong jika tidak ingin mengganti foto sebelumnya.</small>
                            </div>

                            <hr>
                            
                            <button type="submit" class="btn btn-primary w-100 py-2 fw-bold text-uppercase tracking-wide">
                                <i class="ti ti-device-floppy me-2"></i> Perbarui Artikel
                            </button>
                        </div>
                    </div>
                </div>
