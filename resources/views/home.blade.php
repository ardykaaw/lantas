        ...
        <div class="row g-4 justify-content-center">
                ...
                <div class="ig-embed-card animate-on-scroll delay-1">
                    <div class="ig-embed-header">
                        <div class="ig-profile-info">
                            ...
                            <div>
                                <h3 class="ig-username">lantaspoldasultra <i
                                        class="ti ti-rosette-discount-check-filled text-primary"></i></h3>
                                <p class="ig-followers">923K followers</p>
                            </div>
                        </div>
                        <a href="https://instagram.com/lantaspoldasultra" target="_blank" class="ig-btn-view">View
                            profile</a>
                    </div>
                    <div class="ig-img-wrapper"
                        style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); display: flex; align-items: center; justify-content: center; height: 100%; min-height: 250px;">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="ig-embed-card animate-on-scroll delay-2">
                    ...
                    <div class="ig-img-wrapper"
                        style="background: linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%); display: flex; align-items: center; justify-content: center; height: 100%; min-height: 250px;">
            ...
            <div class="col-md-6 col-lg-4 d-none d-lg-block">
                <div class="ig-embed-card animate-on-scroll delay-3">
                    ...
                    <div class="ig-img-wrapper"
                        style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); display: flex; align-items: center; justify-content: center; height: 100%; min-height: 250px;">
                        <div class="text-center text-muted" style="opacity: 0.5;">
                            <i class="ti ti-photo" style="font-size: 3rem;"></i>
                            <div class="mt-2" style="font-size: 0.85rem; font-weight: 500;">Menunggu Update Feed</div>
                        </div>
